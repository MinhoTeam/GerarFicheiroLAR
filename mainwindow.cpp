    ...
    ui(new Ui::MainWindow)
{
    ...
    pixeisMetro = 80.0;//4pixeis por 10cm
    RenderWidth = 5.45*pixeisMetro;  //(18+1.5+1.5) = 21*45 = 945
    RenderHeigth = 7.95*pixeisMetro; //(12+1.5+1.5) = 15*45 = 675
    ...
    //metros
    float ComprimentoCampo = 10.1,LarguraCampo = 7.43,espessuraLinhas = 0.10, RaioCentro = 1.31;
    float LarguraPequenaArea = 3.09,ComprimentoPequenaArea = 0.59, LarguraGrandeArea = 4.32, ComprimentoGrandeArea = 1.45;
    float CantoRaio = 0.6,bolaCentralRaio = 0.075,bolaPenaltiRaio = 0.05,distanciaPenalti = 1.9,larguraBaliza = 2,comprimentoBaliza = 0.5;
    margem = 0.2;
